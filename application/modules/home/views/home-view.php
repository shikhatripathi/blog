...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/plugins/headereffects/css/component.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/plugins/headereffects/css/normalize.css" />
    ...
    <script type="text/javascript" src="<?php echo base_url();?>assets/plugins/slider-plugin/js/slider1.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?><?php echo base_url();?>assets/plugins/slider-plugin/js/slider2.min.js"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/plugins/slider-plugin/css/settings.css"
        media="screen" />
</head>
<!-- END HEAD -->
<body>
                    ...
                    <div class="compressed">
                        <div class="navbar-header">
                            ...
                            <a href="#" class="navbar-brand">
                                <h2>My Perception</h2>
                                <img src="assets/img/logo.png" data-src="<?php echo base_url();?>/assets/img/logo.png" data-src-retina="<?php echo base_url();?>/assets/img/logo_2x.png"
                ...
                <div class="tp-banner" id="home">
                    <ul>
                        ...
                        <li data-transition="fade" data-slotamount="5" data-masterspeed="700">
                            ...
                            <!-- LAYERS -->
                            <div style="background-color: #ffb366 " class="tp-caption mediumlarge_light_white_center sft tp-resizeme slider" data-x="center"
                                ...
                                <h2 class="text-white custom-font title ">
                                    We give you a platform to explore your thoughts<br>
                                 <a href="<?php echo base_url();?>index.php/form/Form" class="btn btn-info btn-lg  btn-large m-r-10" >Create your blog</a>
                                    <br />
                        </h2>
                            </div>
	...
	-->
                        ...
                        <div class="row mt-30">
                            <div class="col-md-4 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s" style="visibility: visible;
                                ...
                                <div class="team-member">
                                    <div class="team-img">
                                        <img src="<?php echo base_url();?>assets/img/team/team_1.png" alt="">
                            ...
                            <div class="col-md-4 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" style="visibility: visible;
                                ...
                                <div class="team-member mt-mdm-40">
                                    <div class="team-img">
                                        <img src="<?php echo base_url();?>assets/img/team/team_2.png" alt="">
                                        <div class="team-details text-center">
                                            <h5 class="team-title mb-10">
                                                Shikha</h5>
                                            <span>CFO</span>
                            ...
                            <div class="col-md-4 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s" style="visibility: visible;
                                ...
                                <div class="team-member mt-mdm-40">
                                    <div class="team-img">
                                        <img src="<?php echo base_url();?>assets/img/team/team_3.png" alt="">
                                        <div class="team-details text-center">
                                            <h5 class="team-title mb-10">
                                                Shiv Sir </h5>
                                            <span>CTO</span>
        ...
        <div  style="background-color:  #ffb366" class="section white footer">
            <div class="container">
                <div class="p-t-30 p-b-50">
                    <div class="row">
                        <div class="col-md-2 col-lg-2 col-sm-2 col-xs-12 xs-m-b-20">
                            <img src="<?php echo base_url();?>assets/img/logo_condensed.png" alt="" data-src="<?php echo base_url();?>assets/img/logo_condensed.png"
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-4  col-xs-12 xs-m-b-20">
                            ...
                            <div class="xs-no-padding col-md-6 col-lg-6 col-sm-6">
                                <div>
                                    (1) 555 666 9999</div>
                                <a href="javascript:">myperception@gmail.com</a>
                            </div>
                            <div class="clearfix">
                            </div>
                        </div>
    ...
    <script src="<?php echo base_url();?>assets/plugins/waypoints.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>/assets/plugins/parrallax/js/jquery.parallax-1.1.3.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>/assets/plugins/jquery-nicescroll/jquery.nicescroll.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>/assets/plugins/jquery-appear/jquery.appear.js"></script>
